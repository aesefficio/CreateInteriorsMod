...
public record ItemDescriptionsCreate(ImmutableList<Component> lines, ImmutableList<Component> linesOnShift, ImmutableList<Component> linesOnCtrl) {
    ...
    public static ItemDescriptionsCreate create(String translationKey, TooltipHelper.Palette palette) {
        ...
        ItemDescriptionsCreate.Builder builder = new ItemDescriptionsCreate.Builder(palette);
    ...
    public static void fillBuilder(ItemDescriptionsCreate.Builder builder, String translationKey) {
        // Summary
    ...
    public static class Builder {
        ...
        public ItemDescriptionsCreate.Builder addSummary(String summaryLine) {
            summary.add(summaryLine);
            return this;
        }

        public ItemDescriptionsCreate.Builder addBehaviour(String condition, String behaviour) {
            behaviours.add(Pair.of(condition, behaviour));
            return this;
        }

        public ItemDescriptionsCreate.Builder addAction(String condition, String action) {
        ...
        public ItemDescriptionsCreate build() {
            ...
            return new ItemDescriptionsCreate(ImmutableList.copyOf(lines), ImmutableList.copyOf(linesOnShift), ImmutableList.copyOf(linesOnCtrl));
        }
    }
